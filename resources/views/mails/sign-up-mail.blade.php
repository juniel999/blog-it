<section class="max-w-2xl px-6 py-8 mx-auto bg-white dark:bg-gray-900">
    <header>
        <a href="#">
            <img class="w-auto h-7 sm:h-8" src="{{ asset('assets/blog-it-logo.png') }}" alt="">
        </a>
    </header>
    ...
    <main class="mt-8">
        ...
        <p class="mt-2 leading-loose text-gray-600 dark:text-gray-300">
            Thank you for registering on <span class="font-semibold ">Blog-It</span>. Welcome to the family!
        </p>
    ...
    <footer class="mt-8">
        <p class="text-gray-500 dark:text-gray-400">
            This email was sent to <a href="#" class="text-blue-600 hover:underline dark:text-blue-400" target="_blank">contact@blog-it.com</a>.
        ...
        <p class="mt-3 text-gray-500 dark:text-gray-400">© 2023 Blog-It. All Rights Reserved.</p>
    </footer>
</section>
